...
const features = [
  {
    ...
    desc: 'Proprietary composite winding technology ensures superior structural integrity at every pressure cycle.',
  ...
  },
  {
    ...
    desc: 'Jointless pressure-tensile construction eliminates rupture risk — no blast, no shrapnel, ever.',
  ...
  },
  {
    icon: Feather,
    title: 'Light Weight',
    desc: 'Up to 50% lighter than traditional steel cylinders — easy to carry, store, and transport.',
  ...
  },
  {
    icon: Sun,
    title: 'UV Resistant',
    desc: 'HDPE outer layer resists UV degradation — safe for outdoor placement in direct sunlight.',
  ...
  },
  {
    ...
    desc: 'Never rusts. Zero iron content means no corrosion from moisture, salt air, or humidity.',
  ...
  },
  {
    ...
    desc: 'ISO 9001-2015 certified with EN 14427-2022 compliance. Inspected by PEC and OGRA Pakistan.',
...
const products = [
  ...
  },
  {
    ...
    slug: '5-kg-lpg-fiber-gas-cylinder-price-in-pakistan',
    price: 8000,
    oldPrice: 8500,
    color: 'Blue',
    weight: '5 kg',
  ...
  {
    name: 'LPG Composite Cylinder 10Kg Cerulean',
    slug: 'lpg-composite-cylinder-10kg-cerulean-blue',
    price: 11000,
    oldPrice: null,
    color: 'Cerulean Blue',
    weight: '10 kg',
  ...
  {
    name: 'LPG Composite Cylinder 10Kg Tiger',
    slug: 'lpg-composite-cylinder-10kg-tiger-orange',
    price: 11000,
    oldPrice: null,
    color: 'Tiger Orange',
    weight: '10 kg',
  ...
  {
    name: 'LPG Composite Cylinder 15Kg Traditional',
    slug: 'lpg-composite-cylinder-10kg-traditional-blue',
    price: 11000,
    oldPrice: null,
...
const certifications = [
  ...
  { label: 'ISO 11119-3', desc: 'Composite Cylinders' },
  { label: 'EN 14427-2022', desc: 'British Standards' },
  { label: 'BS EN 11119', desc: 'European Standards' },
  { label: 'PEC Approved', desc: 'Pakistan Engineering Council' },
  { label: 'OGRA Certified', desc: 'Oil & Gas Regulatory Authority' },
];
...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'I recently switched to a non-explosion gas cylinder and I am incredibly satisfied with my purchase. I highly recommend it to anyone prioritizing safety in their home. This positive technology really made us tension-free.',
  },
  {
    name: 'Ahmed Karimi',
    location: 'Karachi, Pakistan',
    rating: 5,
    text: 'The lightweight design is amazing — my wife can carry it easily. After installing WAA cylinder we have complete peace of mind. The translucent body lets you see exactly how much gas remains.',
  },
  {
    name: 'Sara Malik',
    location: 'Islamabad, Pakistan',
    rating: 5,
    text: 'WAA Tech cylinders are a game-changer. No rust, no leaks, and they look great too. The authorized dealer network made it easy to get one near us.',
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="text-green-200 text-lg leading-relaxed mb-8 max-w-lg">
              Experience the future of cooking gas safety. WAA Technologies&apos; composite LPG cylinders are
              100% explosion-proof, ultralight, and ISO certified — designed for Pakistan&apos;s homes,
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              {['ISO 9001-2015', 'EN 14427-2022', 'PEC Approved', 'OGRA Certified'].map((cert) => (
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-square max-w-md mx-auto bg-gradient-to-br from-green-50 to-emerald-100 rounded-3xl p-10 flex items-center justify-center shadow-xl">
              <div className="text-center">
                ...
                <p className="text-green-600 text-sm">PVT LTD</p>
                <div className="mt-6 flex flex-col gap-2 text-sm text-slate-600">
                  <div className="flex items-center gap-2 bg-white rounded-lg px-3 py-2 shadow-sm">
                    <CheckCircle2 className="w-4 h-4 text-green-600" /> Est. 2017 — R&D since 2018
                  </div>
                  <div className="flex items-center gap-2 bg-white rounded-lg px-3 py-2 shadow-sm">
                    <CheckCircle2 className="w-4 h-4 text-green-600" /> 26,000 sq ft Manufacturing, Gujranwala
                  </div>
                  <div className="flex items-center gap-2 bg-white rounded-lg px-3 py-2 shadow-sm">
                    <CheckCircle2 className="w-4 h-4 text-green-600" /> Pioneering Fiber Composite in Pakistan
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-green-700 font-semibold text-sm uppercase tracking-wider">About WAA</span>
            </div>
            <h2 className="text-4xl font-black text-slate-900 mb-5 leading-tight">
              Pakistan&apos;s Pioneer in<br />
              <span className="text-green-700">Composite LPG Technology</span>
            </h2>
            <p className="text-slate-600 text-lg leading-relaxed mb-5">
              WAA TECHNOLOGIES PVT LTD was formally established in 2022 in Gujranwala, Pakistan — with R&D
              and development work started in 2018. We have since successfully developed and manufactured
              composite gas cylinders using advanced composite winding technologies.
            </p>
            <p className="text-slate-600 leading-relaxed mb-5">
              All the advantages of our cylinders enable us to serve Pakistan&apos;s residential, commercial, and
              industrial customers with cylinders that conform to the highest international standards — ISO
              11119-3 and EN 14427-2022. We maintain a strong reputation for delivering cutting-edge
              performance, proven safety, and long-lasting quality.
            </p>
            <div className="grid grid-cols-2 gap-3 mb-8">
              {['100% Non-Blast Design', 'ISO & PEC Certified', 'Made in Pakistan', '20+ Year Lifespan'].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">
              Here are key features of WAA Technologies Cylinders which stand out the brand.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              Elevate your kitchen game with ours! Say goodbye to non-explosion gas cylinders — WAA
              cylinders are your kitchen&apos;s best friend. Go traditional to modern cooking with ease.
              With safety in mind, our cylinders are leak proof and easy to handle.
            </p>
            <ul className="flex flex-col gap-3 mb-8">
              {[
                'Designed with safety in mind — our cylinders are leak proof and easy to handle.',
                'Enjoy effortless and efficient cooking with non-explosion cylinders in your kitchen.',
                'Perfect for homes, restaurants, camping, and commercial kitchens.',
                'No need to wait for the fire burner to warm up — instant, safe ignition.',
                'Translucent body allows you to visually check remaining LPG level.',
              ].map((item) => (
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-amber-50 to-orange-100 rounded-3xl p-10 shadow-xl">
              ...
              <div className="mt-4 bg-green-700 rounded-2xl p-4 text-white text-center">
                ...
                <div className="text-green-200 text-sm">WAA Gas keeps you cooking 24/7</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-white mb-3">Internationally Certified</h2>
            <p className="text-slate-400 max-w-xl mx-auto">
              Our cylinders meet the most stringent international standards for safety, quality, and performance.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 max-w-xl mx-auto text-lg">
              There are many advantages of our cylinders which make them totally different from steel cylinders.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-green-100 text-lg leading-relaxed mb-6">
              WAA Tech Cylinder quality assures 100% safety from explosions. Highly safe, composite material
              does not hold either static electricity or become engulfed in fire because of their appealing
              shape and 70% less synthetic material than standard cylinders. WAA Tech Cylinders are
              user-friendly — it weighs about 5.5 kg total.
            </p>
            <ul className="flex flex-col gap-3 mb-8">
              {[
                'Free from corrosion — never rusts',
                'No open flame on the body — certified floor-safe',
                'Jointless design minimizes leak points',
                'Translucent body for visible gas level monitoring',
                'Approved under BS EN 14427-2022 standards',
              ].map((item) => (
                <li key={item} className="flex items-center gap-3 text-green-100 text-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              { val: '70%', label: 'Less Material', sub: 'Vs. steel cylinders' },
              { val: '5.5kg', label: 'Total Weight', sub: 'For 10kg cylinder' },
              { val: '20yr+', label: 'Service Life', sub: '12,000 pressure cycles' },
            ].map((s) => (
            ...
            {[
              {
                icon: Sun,
                title: 'UV Resistant',
                desc: 'WAA Tech Cylinder is UV resistant to effects from sun, rain and temperature due to its HDPE outer covering. UV cylinders will not be allowed even.',
              },
              {
                icon: Droplets,
                title: 'Corrosion Free',
                desc: 'WAA Tech Composite Cylinder is corrosion free so it doesn\'t leave stain on kitchen floor or anywhere else. It never gets corroded even if placed in flooded or wet areas.',
              },
              {
                icon: Shield,
                title: 'Certified & Secure',
                desc: 'Security features have been added in design to avoid counterfeit. WAA Tech Cylinder can be customized as per customer preference in color & patterns.',
              },
              {
                icon: Award,
                title: 'Superior Strength',
                desc: 'WAA Technologies have introduced primary cylinders first time ever in Pakistan. The blast-proof technology really made our cylinder — evaluated leakage from body.',
              },
            ].map((f) => (
      ...
      <section className="py-16 bg-amber-400">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-slate-700 text-lg">Find an authorized dealer near you or shop online today.</p>
          </div>
          <div className="flex gap-3 flex-shrink-0">
            <Link
              href="/authorized-dealers"
              className="inline-flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-6 py-3 rounded-xl font-semibold transition-all"
            >
              Find Dealers
            </Link>
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 bg-white hover:bg-slate-50 text-slate-900 px-6 py-3 rounded-xl font-semibold transition-all shadow-sm"
            >
